...
public class ManageSearch<T>{
	...
	private T getRegistroParametro(){
		...
		if (this.getResultados().get(index) != null)
			...
			this.backBean.getView().addLocalDynamicMenssage("Registro selecionado invalido.", "saidaPadrao", true);
			return null;
		}
	}
	...
	public String acaoCarregarRegistro(){
		...
		try {
			PropertyUtils.setNestedProperty(this.getBackBean(), objetoPath , objeto);
