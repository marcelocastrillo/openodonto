...
public abstract class ManageBeanGeral<T extends Entity> {
	...
	this.resourceBundle = ResourceBundle
		.getBundle("br.ueg.openodonto.visao.i18n.mensagens");
	...
	for (String path : camposFormatados) {
		...
		PropertyUtils.setNestedProperty(getBackBean(), path,
			atributoFormatado);
	    }
	}
    }
	...
	try {
	    ...
	    Long id = (Long) PropertyUtils.getNestedProperty(getBackBean(),
		    "codigo");
	...
	init();
	exibirPopUp(this.resourceBundle.getString(alredy ? "Atualizado"
		: "Cadastro"));
