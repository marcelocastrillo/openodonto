...
public class CrudQuery {
    ...
    public static <T extends Entity> IQuery getListQuery(Class<T> classe,
	    String... fields) {
	return new Query(getSelectRoot(classe, fields), Collections.EMPTY_LIST,
		getTableName(classe));
    }

    public static <T extends Entity> IQuery getSelectQuery(Class<?> classe,
	    Map<String, Object> whereParams, String... fields) {
    ...
    public static IQuery getInheritanceConstraintQuery(String table,
	...
	Iterator<String> iterator = translator.getColumnsMap().keySet()
		.iterator();
	while (iterator.hasNext()) {
